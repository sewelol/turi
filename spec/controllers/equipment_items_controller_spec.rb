...
RSpec.describe EquipmentItemsController, type: :controller do
    ...
    describe "POST #create" do
        it "Create a valid equipment_item" do
            ...
            expect(flash[:notice]).to eq(I18n.t 'trip_equipment_item_created')
        end
    ...
    describe "PUT #edit" do
        ...
        it "locate the requested EquipmentItem and redirect to #show equipment_item" do
            ...
            expect(flash[:notice]).to eq(I18n.t 'trip_equipment_item_updated')
        end
        ...
        it "invalid/missing attributes, should not change value of item" do
            ...
            expect(flash[:alert]).to eq(I18n.t 'trip_equipment_item_not_updated')
        end
    end
    ...
    describe "DELETE" do
        ...
        it "Deletes the equipment_item" do
            ...
            expect(flash[:notice]).to eq(I18n.t 'trip_equipment_item_deleted')
        end 
    end
